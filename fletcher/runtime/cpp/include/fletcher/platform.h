...
class Platform {
 public:
  ...
  Status MmioToString(uint64_t fletcher_snap_action_reg_offset, std::string *str, uint64_t start, uint64_t stop, bool quiet = false);
   ...
   */
  inline Status WriteMMIO(uint64_t fletcher_snap_action_reg_offset, uint64_t offset, uint32_t value) { return Status(platformWriteMMIO(fletcher_snap_action_reg_offset, offset, value)); }
  ...
  * @return Status::OK() if successful, otherwise a descriptive error status.
  */
  inline Status ReadMMIO(uint64_t fletcher_snap_action_reg_offset, uint64_t offset, uint32_t *value) { return Status(platformReadMMIO(fletcher_snap_action_reg_offset, offset, value)); }
  ...
  * @return Status::OK() if successful, otherwise a descriptive error status.
  */
  Status ReadMMIO64(uint64_t fletcher_snap_action_reg_offset, uint64_t offset, uint64_t *value);
 ...
 private:
  ...
  fstatus_t (*platformWriteMMIO)(uint64_t fletcher_snap_action_reg_offset, uint64_t offset, uint32_t value) = nullptr;
  fstatus_t (*platformReadMMIO)(uint64_t fletcher_snap_action_reg_offset, uint64_t offset, uint32_t *value) = nullptr;
