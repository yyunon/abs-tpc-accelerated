...
JNIEXPORT jlong JNICALL Java_tpc_spark_arrow_fletcher_NativeParquetReader_initNativeParquetReader(JNIEnv *env, jobject, jobject jmemorypool, jstring java_file_name, jbyteArray schema_file_jarr,
...
JNIEXPORT jboolean JNICALL Java_tpc_spark_arrow_fletcher_NativeParquetReader_readNext(JNIEnv *env, jobject, jlong process_ptr, jlongArray jarr_vector_lengths, jlongArray jarr_vector_null_counts,
...
JNIEXPORT void JNICALL Java_tpc_spark_arrow_fletcher_NativeParquetReader_close(JNIEnv *env, jobject, jlong process_ptr)
{
    delete (DataSetParquetReader *)process_ptr;
}

JNIEXPORT void JNICALL Java_tpc_spark_arrow_fletcher_ParquetReaderEvaluator_readWholeFileWithDefaultMemoryPool(JNIEnv *env, jobject, jstring java_file_name, jbyteArray schema_file_jarr, jint num_rows)
{
