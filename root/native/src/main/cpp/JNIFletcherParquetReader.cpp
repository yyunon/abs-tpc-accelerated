...
//JNIEXPORT jlong JNICALL Java_tpc_spark_arrow_fletcher_FletcherParquetReader_initFletcherParquetReader(JNIEnv *env, jobject, jobject, jlong platform_ptr, jlong jmemorypool, jstring java_file_name, jbyteArray schema_file_jarr,
//																																																			jbyteArray schema_out_jarr,
//																																																			jint num_rows)
//{
//
...
//	std::shared_ptr<arrow::Schema> schema_out = ReadSchemaFromProtobufBytes(schema_out_bytes, schema_out_len);
//        
//        tpc::PlatformWrapper* platform = (tpc::PlatformWrapper *) platform_ptr;
//	//std::shared_ptr<arrow::MemoryPool> pool = std::make_shared<JavaMemoryPool>(env, jmemorypool);
//	//std::shared_ptr<arrow::MemoryPool> pool = std::move(arrow::MemoryPool::CreateDefault());
//	return (jlong) new tpc::FletcherParquetReader(platform, file_name, schema_file, schema_out, (int)num_rows);
//}
//
//JNIEXPORT jdouble JNICALL Java_tpc_spark_arrow_fletcher_FletcherParquetReader_aggregate(JNIEnv *env, jobject, jlong process_ptr)
//{
//
//	tpc::FletcherParquetReader *datasetParquetReader = (tpc::FletcherParquetReader *)process_ptr;
//
//	return datasetParquetReader->Next();
//}
//
//JNIEXPORT void JNICALL Java_tpc_spark_arrow_fletcher_FletcherParquetReader_close(JNIEnv *env, jobject, jlong process_ptr)
//{
//	delete (tpc::FletcherParquetReader *)process_ptr;
//}
